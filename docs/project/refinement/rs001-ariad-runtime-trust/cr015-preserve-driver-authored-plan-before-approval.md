...
Initial scope is Delivery Story flow only. Child order is presentational; exact
scope compares the canonical child-code set. Story-by-story support, semantic
prose equivalence, generalized delegation policies, and every hard gate after
implementation start remain excluded.
