...
|------|-------|------|---------|--------|
| [CV20.DS5.US1](cv20-ds5-us1-review-debt-decision-surface/index.md) | Review debt decision surface | User Story | Navigator sees debt findings and confirms pay-now, defer, or no-action decisions | ✅ Done |
