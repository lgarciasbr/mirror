...
# Review — CV20.DS5.US1 Review Debt Decision Surface
...
- Durable versioned debt ledger remains planned in `CV20.DS5.TS1`.
- Pay-now Refactor loop remains planned in `CV20.DS5.US2`.
