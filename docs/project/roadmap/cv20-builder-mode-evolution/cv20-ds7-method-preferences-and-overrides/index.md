...
# CV20.DS7 — Method Preferences And Overrides
...
|------|-------|------|---------|--------|
| CV20.DS7.TS1 | Preference DSL Model | Technical Story | Builder method definitions can declare typed preferences and source metadata | 🟡 Planned |
| CV20.DS7.TS2 | Project Override Loader | Technical Story | Builder reads `.ariad/config.yml` and merges it with canonical method defaults | 🟡 Planned |
| CV20.DS7.US1 | Inspect Effective Preferences | User Story | Navigator can ask Builder which preferences are active and where they came from | 🟡 Planned |
| CV20.DS7.US2 | Commit Policy Enforcement | User Story | Builder follows the effective commit policy after validated changes | 🟡 Planned |
