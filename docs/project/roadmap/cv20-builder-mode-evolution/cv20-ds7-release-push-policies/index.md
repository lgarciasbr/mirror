...
|------|-------|------|---------|--------|
| [CV20.DS7.US1](cv20-ds7-us1-define-delivery-story-release-intent/index.md) | Define Delivery Story Release Intent | User Story | Builder can optionally record release intent at the Delivery Story level without authorizing release actions | 🟠 In Progress |
