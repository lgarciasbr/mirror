...
| [CV20.DS12.US2](cv20-ds12-us2-route-builder-to-canonical-refinement-files/index.md) | Route Builder To Canonical Refinement Files | User Story | Builder uses the project index for Refinement requests when it exists and preserves legacy behavior for projects without one | 🟡 Planned |
