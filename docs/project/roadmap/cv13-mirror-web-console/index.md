...
| [CV13.E3](cv13-e3-configuration-console/index.md) | Configuration Console | The web app can inspect Mirror configuration currently held in environment variables and manage journey metadata through safe service boundaries | 🟢 In Progress |
