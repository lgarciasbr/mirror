...
| [CV13.E2.S3](cv13-e2-s3-profile-preferences-page/index.md) | Profile/preferences page | The user has a dedicated page for profile-like web preferences scoped to the current Mirror | ✅ Done |
| [CV13.E2.S4](cv13-e2-s4-theme-preference/index.md) | Theme preference | The user can choose light, dark, or system theme and have it persist locally | ✅ Done |
| [CV13.E2.S5](cv13-e2-s5-preference-coherence-and-validation/index.md) | Preference coherence and validation | The multi-Mirror/preference slice is validated across local Mirrors and prepared as v0.12.0 | ✅ Done |
